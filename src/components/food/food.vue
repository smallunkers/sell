        ...
        <div class="food" v-show="showFlag" ref="food">
          <div class="food-content">
            ...
            <div class="rating">
              ...
              <ratingselect :select-type="selectType" :only-content="onlyContent" :desc="desc" :ratings="food.ratings" @eventSelectType="selectRating" @eventToggleContent="toggleContent"></ratingselect>
...
<script type="text/ecmascript-6">
  ...
  import Vue from 'vue';
  import {formatDate} from '../../common/js/date.js';// {}function.可以{formatDate,a}引入多个function
